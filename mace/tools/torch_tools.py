...
def init_wandb(project: str, entity: str, name: str, config: dict, directory: str, group: str = None):
    import wandb

    wandb.init(project=project, entity=entity, name=name, config=config, dir=directory, group=group)
